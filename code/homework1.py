...
if __name__ == "__main__":
    ...
    for feature in ['sift', 'surf', 'orb']:
        for algo in ['kmeans', 'hierarchical']:
            for dict_size in [20, 50]:
                ...
                print 'done', feature, algo, dict_size
    ...
    #             filename2 = 'buildd_' + feature + '_' + algo + '_' + str(dict_size) + '.npy'
    #             buildDict_time.append(np.load(SAVEPATH + filename2))
    ...
    for i, vocab in enumerate(vocabularies):
        ...
        build_time = buildDict_time[i] + bow_time[i]
        knn_runtimes.append(round(build_time + (end - start), 2))
    
    print 'acck', knn_accuracies
    print 'runk', knn_runtimes
    ...
    for i, vocab in enumerate(vocabularies):
        ...
        build_time = buildDict_time[i] + bow_time[i]
        lin_runtimes.append(round(build_time + (end - start), 2))
    ...
    for i, vocab in enumerate(vocabularies):     
        ...
        build_time = buildDict_time[i] + bow_time[i]
        rbf_runtimes.append(round(build_time + (end - start), 2))
